...
Footer15.defaultProps = {
  ...
  copyright: '© 2024 New Cryptocurrency. All rights reserved.',
  content2:
    'Stay updated with the latest news and trends in the cryptocurrency world.',
  termsLink: 'https://example.com/terms',
  logoAlt: 'New Cryptocurrency Logo',
  logoSrc: 'https://presentation-website-assets.teleporthq.io/logos/logo.png',
  action1: 'Join the trend now!',
  content1:
    'Discover the future of finance with our innovative cryptocurrency.',
  cookiesLink: 'https://example.com/cookies',
}
